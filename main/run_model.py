...
def train():
    ...
    # defining model
    MITOR_V2 = model.Model(config.input_dim, config.hidden_dim_1, config.hidden_dim_2, config.hidden_dim_3, logger)
...
if __name__ == '__main__':
    ...
    # test('08_09_2022_06_55_38_MITOR_V2_mlp250.obj') # Flu 11-12
